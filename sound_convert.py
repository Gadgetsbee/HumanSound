...
def save_image_from_sound(img_path):
    ...
    lp=lp+1
    for i in range(0,2):
        filename=str(i)+str(lp)
        plt.imshow(x, interpolation='nearest')
        plt.savefig(r'C:\Users\Ishwarya\Downloads\FINAL YR PROJECT\Project\data\obstructive' + filename)
        #plt.show()
...
import os
for i, fn in enumerate(os.listdir(r'C:\Users\Ishwarya\Downloads\FINAL YR PROJECT\Project\data\obstructive')):
    print(i)
    print(fn)
    path = r'C:\Users\Ishwarya\Downloads\FINAL YR PROJECT\Project\data\obstructive' + fn
